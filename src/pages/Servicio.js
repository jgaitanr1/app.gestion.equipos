...
import { ServicioEntity } from './../Entity/ServicioEntity';
...
export const Servicio = () => {
    ...
    let empty = ServicioEntity;

    const baseUrl = environment.baseUrl + "servicio/";
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <Button label="Registrar Servicio" icon="pi pi-plus-circle" className="p-button-outlined p-button-success mr-2" onClick={openNew} />
                </div>
            </React.Fragment>
        )
    }
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="actions">
                <Button title="Modificar Servicio" icon="pi pi-pencil" className="p-button-rounded p-button-outlined p-button-success mr-2" onClick={() => editProduct(rowData)} />
            </div>
        );
    }
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Configuración de Servicios</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable ref={dt} value={data} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                        ...
                        currentPageReportTemplate="Ver {first} a {last} de {totalRecords} Servicios"
                    ...
                    <Dialog visible={EntidadNewDialog} style={{ width: '700px' }} header="Datos de Servicio" modal className="p-fluid" footer={productDialogFooterNew} onHide={hideDialogNew}>
                        <div className="field col-12">
                            <div className="formgrid grid">
                                <div className="field col-12 md:col-12">
                                    <label htmlFor="nombre">Nombre de Servicio</label>
                                    ...
                                    {submitted && !product.nombre && <small className="p-invalid">El nombre del servicio es requerido.</small>}
                                </div>
                            </div>
                        </div>
                    </Dialog>
